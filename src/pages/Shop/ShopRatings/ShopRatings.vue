  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        ...
        <div class="switch" :class="{on: onlyShowText}" @click="toggleOnlyShowType">
...
export default {
  data () {
    return {
      ...
      selectType: 2 // 选择评价类型 ; 0为满意,1不满意,2全部
    }
  },
  mounted () {
  ...
  computed: {
    ...
    filterShopRatings () {
      const {shopRatings, onlyShowText, selectType} = this // 得到相关的数据
      // 产生一个新的数组
