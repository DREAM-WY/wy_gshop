  ...
  <div class="shop-info">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item" v-for="(support, index) in shopInfo.supports" :key="index" :class="shopPreferential[support.type]">
...
export default {
  data () {
    return {
      shopPreferential: ['activity-green', 'activity-red', 'activity-orange']
    }
  },
  mounted () {
