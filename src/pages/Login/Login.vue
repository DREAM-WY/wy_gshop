    ...
    <div class="loginInner">
      <div class="login_header">
        ...
        <div class="login_header_title">
          <a href="javascript:;" :class="{on: loginWay}" @click="changeLogin">短信登录</a>
          <a href="javascript:;" :class="{on: !loginWay}" @click="changeLogin">密码登录</a>
        </div>
      </div>
...
import {reqPwdLogin, reqSetCode, reqSmsLogin} from '../../api'
export default {
  data () {
    return {
  ...
  methods: {
    ...
    async getCode () {
      ...
      if (!this.computeTime) {
        ...
        const result = await reqSetCode(this.phone)
        if (result.code === 1) {
          // 显示提示
