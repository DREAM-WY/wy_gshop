  ...
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="shopInfo.supports" @click="toggleSupportShow">
      <div class="discounts-left">
        <div class="activity" :class="suppportClasses[shopInfo.supports[0].type]">
          <span class="content-tag">
    ...
    <transition name="fade">
      ...
      <div class="activity-sheet-content">
        ...
        <ul class="list" >
          <li class="activity-item" :class="suppportClasses[support.type]" v-for="(support, index) in shopInfo.supports" :key="index">
            <span class="content-tag">
